# Mode — CV Formatting and Content in LaTeX

<purpose>
Generate a tailored, ATS-compliant, 1-page A4 LaTeX CV from `config/profile.md` and a job description. Compile to PDF via `generate-pdf.mjs`.
</purpose>

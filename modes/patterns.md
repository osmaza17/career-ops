...
- `config/_profile.md` — User archetypes and framing
...
> - Set a score threshold in `config/_profile.md` for PDF generation
...
- For profile/archetype changes: edit `config/_profile.md` (NEVER `_shared.md`)

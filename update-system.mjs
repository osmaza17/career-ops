...
const CANONICAL_REPO = 'https://github.com/osmaza17/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/osmaza17/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/osmaza17/career-ops/releases/latest';

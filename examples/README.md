...
| `portfolio-example.md` | How to write `portfolio.md` -- compact proof points with hero metrics, architecture summaries, and key decisions per project |
...
2. Use `cv-example.md` as a structural guide when writing your `config/cv.md`.
3. Use `portfolio-example.md` as a template for your `config/portfolio.md` (optional but improves evaluation quality).
